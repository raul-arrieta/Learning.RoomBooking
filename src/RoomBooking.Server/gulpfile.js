...
gulp.task("copy-dependencies",
    ...
    function() {
        ...
        gulp.src(paths.npmSrc + "angular2-in-memory-web-api/*.*",
                { base: paths.npmSrc + "angular2-in-memory-web-api/" })
...
gulp.task("build",
    ["clean", "copy-front", "compile-typescript", "copy-dependencies"],
    function() {
